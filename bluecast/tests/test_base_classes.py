...
from bluecast.ml_modelling.base_classes import XgboostBaseModel, CatboostBaseModel
...
class TestXgboostBaseModel:
    ...
    def test_create_optuna_study_with_database_backend_and_tpe_sampler(self, xgboost_base_model):
    ...
    def test_create_optuna_study_with_database_backend_and_simple_sampler_with_seed(self, xgboost_base_model):
    ...
    def test_create_optuna_study_with_database_backend_and_sampler_without_seed(self, xgboost_base_model):
    ...
    def test_create_optuna_study_sampler_save_error_handling(self, xgboost_base_model):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch('pickle.dump', side_effect=Exception("Mocked pickle error")) as mock_dump:
                with patch('logging.warning') as mock_warning:
                    ...
                    mock_warning.assert_called_with("Could not save sampler state: Mocked pickle error")
    ...
    def test_create_optuna_study_with_database_backend_none(self, xgboost_base_model):
        ...
        study = xgboost_base_model._create_optuna_study(
            direction="minimize",
            sampler=sampler,
            study_name="test_no_db_study"
        )
        
        assert isinstance(study, optuna.Study)
        assert study.study_name == "test_no_db_study"

    def test_create_optuna_study_with_database_backend_non_string(self, xgboost_base_model):
        ...
        study = xgboost_base_model._create_optuna_study(
            direction="minimize",
            study_name="test_non_string_db_study"
        )
...
class TestCatboostBaseModel:
    ...
    def test_catboost_create_optuna_study_basic(self, catboost_base_model):
        ...
        study = catboost_base_model._create_optuna_study(
            direction="minimize",
            study_name="test_catboost_study"
        )
    ...
    def test_catboost_create_optuna_study_with_database_backend(self, catboost_base_model):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            study = catboost_base_model._create_optuna_study(
                direction="minimize",
                study_name="test_catboost_db_study"
            )
    ...
    def test_catboost_create_optuna_study_with_database_backend_and_simple_sampler(self, catboost_base_model):
    ...
    def test_catboost_create_optuna_study_sampler_save_error_handling(self, catboost_base_model):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch('builtins.open', side_effect=PermissionError("Permission denied")):
                with patch('logging.warning') as mock_warning:
                    ...
                    # Verify that warning was logged
                    mock_warning.assert_called_with("Could not save sampler state: Permission denied")
    ...
    def test_xgboost_database_backend_file_creation_with_error_handling(self):
        ...
        with pytest.raises(Exception):  # Could be OperationalError or similar
            study = model._create_optuna_study(
                direction="minimize",
                study_name="test_permission_study"
            )

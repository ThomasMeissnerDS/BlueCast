...
def test_transform_target_encode_binary_class(sample_data):
    ...
    encoder.fit_target_encode_binary_class(sample_data[['col1', 'col2']], sample_data['target'])

    # Transform the sample data using the fitted encoder
    transformed_data = encoder.transform_target_encode_binary_class(sample_data[['col1', 'col2']])
    ...
    expected_values = pd.DataFrame({
        'col1': [0.5, 0.5, 0.5, 0.5, 0.5, 0.5],
        'col2': [0.5, 0.5, 0.5, 0.5, 0.5, 0.5]
    })

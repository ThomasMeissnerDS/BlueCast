...
def test_label_encoder_transform(trained_label_encoder, sample_data):
    transformed_data = trained_label_encoder.transform_target_labels(sample_data['target'])
...
def test_label_encoder_reverse_transform(trained_label_encoder, sample_data):
    ...
    reversed_data = trained_label_encoder.label_encoder_reverse_transform(transformed_data['target'])
    expected_data = pd.DataFrame({
        'target': ['A', 'B', 'C', 'A', 'B', 'C']
    })

...
def test_train_test_split_cross():
    ...
    x_train, x_test, y_train, y_test = train_test_split_cross(df, target_col, train_size, random_state)
...
def test_train_test_split_time():
    ...
    x_train, x_test, y_train, y_test = train_test_split_time(df, target_col, split_by_col, train_size)

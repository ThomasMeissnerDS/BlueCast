...
def main():
    ...
    print("Initializing MLPRegressionModel (PyTorch)...")
    model = MLPRegressionModel(scoring="neg_mean_absolute_error")
    
    # Configure tuning rounds — give it enough budget to explore
    # hidden_layer_sizes, activation, alpha, learning_rate, batch_size, dropout
    model.conf_tuning = {
        "tuning_rounds": 30,
